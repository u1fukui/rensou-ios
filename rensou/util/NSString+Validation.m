...
// 参照：http://trenskow.com/emoji-nscharacterset-objective-c-category/
...
static NSCharacterSet *_emojiCharacterSet = nil;

+ (BOOL)isEmoji:(NSString *)string
{
    // CharacterSet作成
    if (_emojiCharacterSet == nil) {
        _emojiCharacterSet = [NSString emojiCharacterSet];
    }
    ...
    // 絵文字判定
    NSCharacterSet *emojiCharSet = [NSString emojiCharacterSet];
    NSScanner *aScanner = [NSScanner localizedScannerWithString:string];
    [aScanner setCharactersToBeSkipped:nil];
    [aScanner scanCharactersFromSet:emojiCharSet intoString:NULL];
